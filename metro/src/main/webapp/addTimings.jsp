...
<head>
    <title>Add Timings | Metro Portal</title>
...
<body>
    <header class="text-white py-3 px-4 d-flex justify-content-between align-items-center shadow">
        ...
        <div class="d-flex align-items-center">
            <img src="getImage/${dto.fileName}" class="rounded-circle me-2 border border-primary" alt="img" width="50"
    ...
    <section class="container my-5">
        <div class="metro-card p-4 mx-auto" style="max-width: 700px;">
            ...
            <form action="addTimings/${dto.email}" method="post">
                <input type="text" name="email" value="${dto.email}" hidden>

                <div class="mb-3">
                    <label for="source" class="form-label">Source Station</label>
                    <input type="text" name="source" id="source" class="form-control" placeholder="Enter Source Station" required />
                </div>

                <div class="mb-3">
                    <label for="destination" class="form-label">Destination Station</label>
                    <input type="text" name="destination" id="destination" class="form-control" placeholder="Enter Destination Station" required />
                </div>
                ...
                <div class="text-center">
                    <button type="submit" id="button" class="btn btn-metro px-4">Add Timings</button>
                </div>
            </form>
        </div>
    </section>
