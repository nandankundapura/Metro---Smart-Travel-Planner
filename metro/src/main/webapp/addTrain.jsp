...
<head>
    <title>Add Train | Metro Portal</title>
    ...
    <section class="container my-5">
        <div class="metro-card p-4 mx-auto" style="max-width: 700px;">
            ...
            <h5 class="text-center mb-4">
                <span class="material-icons align-middle me-2">directions_subway</span>
                ADD TRAIN TYPE & TRAIN NUMBER
            </h5>
            ...
            <form action="addTrain/${dto.email}" method="post">
                ...
                <div class="mb-3">
                    <label for="trainType" class="form-label">Add Train Type</label>
