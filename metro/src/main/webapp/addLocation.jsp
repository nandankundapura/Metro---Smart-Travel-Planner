...
<html lang="en">
<head>
    <title>Add Location | Metro Portal</title>
...
<section class="container my-5">
    <div class="metro-card p-4 mx-auto" style="max-width: 700px;">
        ...
        <h5 class="text-center mb-4">
            <span class="material-icons align-middle me-2">train</span>
            ADD LOCATIONS
        </h5>

        <form action="location/${dto.email}" id="myForm" method="post">
            ...
            <div class="mb-3">
                <label for="locationsName" class="form-label">Select Station</label>
